        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <FadeIn>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
              Bem-vindo à <span className="text-accent">{tenant.nome}</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link to={`/${tenant.slug}/agendar`}>
                <Button size="lg" className="bg-accent text-background hover:bg-accent/90">Agendar Horário</Button>
              </Link>
              <Link to={`/${tenant.slug}/#servicos`}>
          ...
          <FadeIn delay={0.2} className="relative">
            <div className="aspect-square rounded-2xl overflow-hidden border-2 border-accent/30">
              <img
